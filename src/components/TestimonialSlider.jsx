    ...
    testimonials: [
      {
        ...
        message:
          "Trabajamos con VelyonSoft y crearon una web rápida, moderna y totalmente optimizada para nuestro negocio. Desde el primer mes aumentaron los clientes.",
    ...
    testimonials: [
      {
        ...
        role: "Business Owner",
        message:
          "We worked with VelyonSoft and they built a fast, modern, and fully optimized website. We saw more clients from the first month.",
        avatar: "https://i.pravatar.cc/150?img=12",
      },
      {
        name: "María Valdivia",
